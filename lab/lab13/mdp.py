...
class mdp:
            ...
            for i in range (self.state_space[0]):
                for j in range (self.state_space[1]):
                    ...
                    for action_index, action_prob in enumerate(self.policy_matrix[i, j]): 
                        ...
                        rewarded_value = (reward + policy_value[next_state_index[0], next_state_index[1]] * self.gamma) * action_prob
                        temp_action_value += rewarded_value
                    ...
                    delta = max(delta, abs(old_value - temp_action_value))
    ...
    def value_iteration(self, threshold=0.01):
            ...
            for i in range(self.state_space[0]):
                for j in range(self.state_space[1]):
                    ...
                    for action_index, action_prob in enumerate(self.policy_matrix[i, j]): 
                        ...
                        rewarded_value = reward + policy_value[next_state_index[0], next_state_index[1]] * state_prob
                        temp_action_value.append(rewarded_value)
        ...
        for i in range(self.state_space[0]):
                for j in range(self.state_space[1]):
                    if self.grid_map.reward_matrix[i, j] == -10:
                        policy_value[i, j] = -100
                    elif self.grid_map.reward_matrix[i, j] == 10:
                        policy_value[i, j] = 100
    ...
    def get_value_action(self, policy_value, state_index):
        ...
        for action in self.action_space:
            nxt_index = [state_index[0] + action[0], state_index[1] + action[1]]
            temp_action_value.append(policy_value[nxt_index[0], nxt_index[1]])
